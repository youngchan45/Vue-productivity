    ...
    <el-tab-pane>
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick" stretch>
        ...
        <el-tab-pane label="领导干部信息表(二)" name="third">
            ...
            <el-card class="basic everyLine">
              <el-row>
                <el-col>
                  ...
                  <el-col :span="6">{{incomesTwo.total }}</el-col>
                  <el-col :span="6">工资（含津贴、补贴）（万元/全年）</el-col>
                  <el-col :span="6">{{incomesTwo.basicInfoId}}</el-col>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-col :span="6">奖金（万元/全年）</el-col>
                  <el-col :span="6">{{incomesTwo.bonus }}</el-col>
                  <el-col :span="6">其他（万元/全年）</el-col>
                  <el-col :span="6">{{incomesTwo.others}}</el-col>
                </el-col>
              </el-row>
            </el-card>
          </div>
          ...
          <el-card class="basic everyLine">
            <el-row>
              <el-col>
                <el-col :span="6">合计（万元/全年）</el-col>
                <el-col :span="6">{{otherIncomes.total }}</el-col>
                <el-col :span="6">讲学（万元/全年）</el-col>
                <el-col :span="6">{{otherIncomes.lecture}}</el-col>
              </el-col>
            </el-row>
            <el-row>
              <el-col>
                <el-col :span="6">写作（万元/全年）</el-col>
                <el-col :span="6">{{otherIncomes.writing }}</el-col>
                <el-col :span="6">咨询（万元/全年）</el-col>
                <el-col :span="6">{{otherIncomes.consultant}}</el-col>
              </el-col>
            </el-row>
            <el-row>
              <el-col>
                <el-col :span="6">审稿（万元/全年）</el-col>
                <el-col :span="6">{{otherIncomes.review }}</el-col>
                <el-col :span="6">书画（万元/全年）</el-col>
                <el-col :span="6">{{otherIncomes.painting}}</el-col>
              </el-col>
            </el-row>
            <el-row>
              <el-col>
                <el-col :span="6">其他（万元/全年）</el-col>
                <el-col :span="6">{{otherIncomes.others }}</el-col>
              </el-col>
            </el-row>
          </el-card>
          ...
          <div v-for="item in familyBusinesses" :key="item.id">
            <el-card class="basic everyLine">
              <el-row>
                <el-col>
                  <el-col :span="6">称谓</el-col>
          ...
          <div v-for="item in famityCars" :key="item.id">
            <el-card class="basic everyLine">
              <el-row>
                <el-col>
                  <el-col :span="6">称谓</el-col>
        ...
        <el-tab-pane label="领导干部信息表(三)" name="fourth">
          ...
          <h5>被谈话函询情况</h5>
          <div v-for="item in talkInquirys" :key="item.id">
            <el-card class="basic everyLine">
              <h5>被谈话函询情况(item[index])</h5>
              <el-row>
                <el-col>
    ...
    async getBasicInfo() {
      await this.$http
        ...
        .then(res => {
          ...
          //表三
          if (this.type == 2) {
            this.incomesTwo = res.data.data.incomes[0];
            this.famityCars = res.data.data.famityCars;
            this.estateInfos = res.data.data.estateInfos;
            this.otherIncomes = res.data.data.otherIncomes[0];
